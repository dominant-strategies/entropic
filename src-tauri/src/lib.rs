...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_rnn_runtime_status,
            commands::get_rnn_catalog,
            commands::download_rnn_model,
            commands::load_rnn_model,
            commands::unload_rnn_model,
            commands::delete_rnn_model,
            commands::warm_rnn_model,
            commands::install_rnn_runtime_backend,
            commands::update_rnn_runtime_config,
            commands::stop_rnn_runtime,
            commands::discover_local_model_ids,
            commands::test_local_model_connection,
            commands::debug_local_model_chat,
